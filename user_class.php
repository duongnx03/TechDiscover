...
class User {
    ...
    public function insert_user($email, $username, $password, $fullname, $address, $phone) {
        ...
        $query = "INSERT INTO user (email, username, password, fullname, address, phone) 
    ...
    public function show_users() {
        $query = "SELECT id, email, username, password , fullname, address, phone FROM user ORDER BY id DESC";
        $result = $this->db->select($query);
        return $result;
    }

    public function get_user_by_id($user_id) {
        $query = "SELECT id, email, username, password , fullname, address, phone FROM user WHERE id = '$user_id'";
        $result = $this->db->select($query);
        return $result;
    }
