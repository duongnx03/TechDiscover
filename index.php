        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="shop-cat-box">
                    ...
                    <a class="btn hvr-hover" href="#">Smartphone</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="title-all text-center">
                    ...
                    <p>With top selling products and huge discounts.</p>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row special-list">
            <div class="col-lg-3 col-md-6 special-grid best-seller">
                <div class="products-single fix">
                    ...
                    <div class="why-text">
                        <h4>iPhone 14 PROMAX 256GB</h4>
                        <h5><del>$1777.79</del><a href=""> $1729.79</a></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 special-grid top-featured">
                <div class="products-single fix">
                    <div class="box-img-hover">
                        ...
                        <img src="admin/uploads/samsung_galaxy_z_fold_4-10_1.jpg" class="img-fluid" alt="Image">
                        <div class="mask-icon">
                            <ul>
                                <li><a href="#" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                <li><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="why-text">
                        <h4>samsung_galaxy_z_fold 4</h4>
                        <h5><del>$1277.79</del><a href=""> $1229.79</a></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 special-grid top-featured">
                <div class="products-single fix">
                    ...
                    <div class="why-text">
                        ...
                        <h5><del>$977.79</del><a href=""> $929.79</a></h5>
                    </div>
                </div>
            </div>
