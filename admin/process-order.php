...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // $insert_query = ("insert into tbl_order (user_id, order_date, payment_method, order_status, user_info, total_order, status_payment) values 
    //     ($user_id, '$currentDateTime', '$selectedPaymentMethod', '$order_status', '$user_info', '$total_order', '$status_payment')");
